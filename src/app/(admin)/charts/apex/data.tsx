...
export const secondBubbleChartOpts: ApexOptions = {
  ...
  colors: ['#007aff', '#47ad77', '#fa5c7c', '#39afd1'],
  xaxis: {
    tickAmount: 12,
    type: 'datetime',
...
//   Simple Pie Chart
const colors1 = ['#007aff', '#6c757d', '#4489e4', '#d03f3f', '#edc755']
...
export const SimpleDonutOpt: ApexOptions = {
  ...
  labels: ['Series 1', 'Series 2', 'Series 3', 'Series 4', 'Series 5'],
  colors: ['#007aff', '#6c757d', '#4489e4', '#d03f3f', '#edc755'],
  responsive: [
    {
      breakpoint: 600,
      options: {
...
export const multipleRadialBarOpts: ApexOptions = {
  ...
  colors: ['#007aff', '#4489e4', '#edc755', '#33b0e0'],
  series: [44, 55, 67, 83],
