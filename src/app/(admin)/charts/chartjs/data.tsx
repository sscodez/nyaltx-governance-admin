...
const datasetColors = ['#007aff', '#4489e4', '#d03f3f', '#716cb0', '#f24f7c']
...
const colors2 = ['#007aff', '#4489e4', '#d03f3f', '#716cb0']
...
export { boundariesConfig, datasetConfig, borderRadiusConfig, floatingConfig, interpolationConfig, lineConfig, bubbleConfig, donutConfig }
